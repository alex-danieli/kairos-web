...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-users"></i> Tags <input type="button" class="btn btn-success" value="Add" name="add"></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">KAIROS - TAGS</div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="tagsTable" data-toggle="table"
										data-toggle="table"
										data-url="api/tagList.php"
								...
								>
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="de_tag" data-sortable="true">Description</th>
											<th data-field="cod_uid" data-sortable="true">RFID UID</th>
