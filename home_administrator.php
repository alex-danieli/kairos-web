                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php $users=get_active_users_number(); echo $users["num_users"]+0; ?></div>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php $detectors=get_active_detectors_number(); echo $detectors["num_detectors"]+0; ?></div>
                                    <div>Active Detectors</div>
                                </div>
                            </div>
                        </div>
                        <a href="detectors.php">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php $tags=get_active_tags(); echo $tags["num_tags"]+0; ?></div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php $tags=get_unknown_tags(); echo $tags["num_tags"]+0; ?></div>
                                    <div>Unknown tags!</div>
                                </div>
                            </div>
                        </div>
                        <a href="tags.php">
