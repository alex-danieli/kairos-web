...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-users"></i> Users <input type="button" class="btn btn-success" value="Add" name="add"></h1> 
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">KAIROS - USERS</div>
                        <!-- /.panel-heading --> 
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="usersTable" data-toggle="table"
										data-toggle="table"
										data-url="api/userList.php"
								...
								> 
                                    <thead> 
                                        <tr>
                                            ...
                                            <th data-field="txt_surname" data-sortable="true">Surname</th>
                                            <th data-field="txt_name" data-sortable="true">Name</th>
                                            <th data-field="txt_username" data-sortable="true">Username</th>
                                            <th data-field="fg_status" data-formatter="statusFormatter" data-width="1%" data-align="center">Status</th>
	...
	<script>
		...
		function statusFormatter(value, row, index) {
			if(value==0) return '<span class="fa-stack"><i class="fa fa-user fa-stack-1x" style="color:grey"></i><i class="fa fa-ban fa-stack-2x text-danger"></i></span>';
			if(value==1) return '<i class="fa fa-user fa-2x " style="color:green"></i>';
		}			  
